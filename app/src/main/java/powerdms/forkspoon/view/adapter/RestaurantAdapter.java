...
public class RestaurantAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private List<Restaurant> original_items = new ArrayList<>();
    public List<Restaurant> filtered_items = new ArrayList<>();
    private int visibleThreshold = 10;
    private int lastVisibleItem, totalItemCount;
    public OnItemClickListener mListener;
    public OnLoadMoreListener mOnLoadMoreListener;

    public RestaurantAdapter(Context context, RecyclerView recyclerView, OnItemClickListener onItemClickListener) {
    ...
    public class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Restaurant> list = original_items;
            final List<Restaurant> result_list = new ArrayList<>(list.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Restaurant>) results.values;
            notifyDataSetChanged();
        }
    }
}
