...
public class NearbyRestaurantAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private List<NearbyRestaurant> original_items = new ArrayList<>();
    public List<NearbyRestaurant> filtered_items = new ArrayList<>();
    private int visibleThreshold = 10;
    private int lastVisibleItem, totalItemCount;
    public OnItemClickListener mListener;
    public OnLoadMoreListener mOnLoadMoreListener;

    public NearbyRestaurantAdapter(Context context, RecyclerView recyclerView, OnItemClickListener onItemClickListener) {
    ...
    public void AddItems(List<NearbyRestaurant> items) {
    ...
    public class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<NearbyRestaurant> list = original_items;
            final List<NearbyRestaurant> result_list = new ArrayList<>(list.size());

            for (int i = 0; i < list.size(); i++) {
                String str_name = list.get(i).getRestaurant().getName();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<NearbyRestaurant>) results.values;
            notifyDataSetChanged();
        }
    }
}
